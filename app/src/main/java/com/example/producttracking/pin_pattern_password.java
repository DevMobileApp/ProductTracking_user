...
public class pin_pattern_password extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pin_pattern_password);
            ...
            try {
                ...
                try {
                   ...
                   // startActivityForResult(intent, SECURITY_SETTING_REQUEST_CODE);
                    ...
                    finish();
                    startActivity(new Intent(pin_pattern_password.this,Product_item_monitor.class));
